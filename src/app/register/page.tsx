...
const dict = {
  ru: {
    roleCopy: {
      parent: {
        nameLabel: "Имя",
        namePlaceholder: "Напиши имя",
        childNameLabel: "Имя ребёнка",
        childNamePlaceholder: "Напиши имя ребёнка",
        showChildFields: true,
      },
      teacher: {
        nameLabel: "Имя",
        namePlaceholder: "Напиши имя",
        childNameLabel: "Имя ученика для демо",
        childNamePlaceholder: "Напиши имя ученика",
        showChildFields: true,
      },
      student: {
        nameLabel: "Как тебя зовут",
        namePlaceholder: "Напиши имя",
        childNameLabel: "Имя в уроках",
        childNamePlaceholder: "Можно то же имя",
        showChildFields: true,
      },
      researcher: {
        nameLabel: "Имя",
        namePlaceholder: "Например, Олеся Маркова",
        showChildFields: false,
      },
    } as Record<UserRole, RoleCopy>,
    consentRequired: "Поставь галочку, чтобы продолжить.",
    createFailed: "Не получилось создать кабинет.",
    eyebrow: "Новый кабинет",
    heading: "Создай свой кабинет.",
    lead: "Заполни поля. Это просто. Если не знаешь что писать — попроси взрослого.",
    whoLabel: "Кто ты",
    parentOpt: "Родитель",
    studentOpt: "Ученик",
    teacherOpt: "Педагог",
    researcherOpt: "Исследователь",
    emailLabel: "Почта",
    emailPlaceholder: "Напиши почту",
    passwordLabel: "Пароль",
    passwordPlaceholder: "Придумай пароль",
    classLabel: "Класс",
    classPlaceholder: "Например, 3",
    consentPrefix: "Я согласен с ",
    consentLink: "правилами",
    consentSuffix: ".",
    creating: "Создаю...",
    createButton: "Создать кабинет",
    haveCabinet: "Уже есть кабинет?",
    loginLink: "Войти",
  },
  uz: {
    roleCopy: {
