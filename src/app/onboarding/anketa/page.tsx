...
const dict = {
  ru: {
    defaultChild: "вашего ребёнка",
    saveFailed: "Не удалось сохранить анкету. Попробуйте ещё раз.",
    loading: "Загружаем анкету...",
    step: "Шаг 2 из 2 — короткий опрос",
    headingPrefix: "Расскажите, как сейчас у",
    headingSuffix: "с цифровыми навыками",
    lead: "Это нужно, чтобы программа могла измерить эффект обучения. 5 коротких вопросов, оценка от 1 до 5. После — попадёте в кабинет.",
    filled: "Заполнено",
    of: "из",
    saving: "Сохраняем...",
    finish: "Завершить и войти в кабинет",
    logout: "Выйти и заполнить позже",
  },
  uz: {
