...
const dict = {
  ru: {
    ...
    teachers: "Teachers",
    studentsInExport: "Students in unloading",
    experimentalGroup: "Experimental group",
    controlGroup: "Control group",
    noGroup: "Without a group",
    progressHeader: "— PROGRESS —",
    avgScoreAll: "GPA (all)",
    questionnairesHeader: "— QUESTIONNAIRE —",
    initialFilled: "Completed entrance forms",
    finalFilled: "Completed exit forms",
    avgInitialExp: "Wed. entrance score - Exp.",
    avgFinalExp: "Wed. point day off - Exp.",
    deltaExp: "Gain - Exp.",
    avgInitialCtrl: "Wed. input score - Control.",
    avgFinalCtrl: "Wed. point output - Control.",
    deltaCtrl: "Gain - Cont.",
    exportDate: "Unloading date",
    ...
    idForLink: "ID (for communication)",
    yes: "Yes",
    no: "No",
    notVisited: "Didn't enter",
    eventsSheet: "Events",
    dateTime: "Date and time",
    student: "Student",
    lesson: "Lesson",
    action: "Action",
    correctAnswersCol: "Correct answers",
    wrongAnswersCol: "Errors",
    hintsCol: "Hints",
    studentId: "Student ID",
    questionnairesSheet: "Questionnaires",
    filledDate: "Date completed",
    questionnaireType: "Type of questionnaire",
    totalScore: "Sum of points",
    questionN: (n: number) =>`Question${n}`,
    questionsLegendSheet: "Question texts",
    number: "Number",
    questionText: "Question text",
    beforeAfterSheet: "Before - After",
    lessons: "Lessons",
    avgScoreShort: "Wed. point",
    initialScore: "Entry form score",
    finalScore: "Exit questionnaire score",
    delta: "Gain",
    initialDate: "Entry form date",
    finalDate: "Date of exit questionnaire",
    noQuestionnaire: "No profile",
    initialType: "Entrance",
    finalType: "Day off",
    groupExperimental: "Experimental",
    groupControl: "Test",
    groupNone: "Without a group",
    actionLessonStart: "Start of the lesson",
    actionLessonComplete: "End of the lesson",
    actionStepView: "View step",
    actionStepComplete: "Step completed",
    actionAnswerCorrect: "Correct answer",
    actionAnswerWrong: "Error",
    actionHintUsed: "Hint used",
    intlLocale: "ru-RU",
  },
  uz: {
    overview: "Umumiy",
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <dc:title>Mosaic Researcher Export</dc:title>
