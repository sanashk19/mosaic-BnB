...
const englishMaterialDict = {
  materialAria: (title: string) => `Lesson material: ${title}`,
  planTitle: "Lesson plan — how to conduct",
  goalsTitle: "Lesson Objectives",
  rulesTitle: "Rules for the learner",
  trainerTitle: "Lesson Trainer",
  trainerIntro1: "The student will open an interface similar to real-life ",
  trainerIntro2: ", and try to complete the task with hints.",
  taskLabel: "Task:",
  scenariosTitle: (count: number) => `Learning Scenarios (${count})`,
  situation: "Scenario",
  correct: "correct",
  feedbackLabel: "Feedback:",
  supportLabel: "Facilitator tip:",
  quizTitle: (count: number) => `Knowledge Check (${count} questions)`,
  question: "Question",
  noteTeacher: "Teacher note",
  noteParent: "Parent note",
  topicsTitle: "Lesson topics",
} as const;

const dict = {
  ru: englishMaterialDict,
  uz: englishMaterialDict,
} as const;
