...
const dict: Locales<{
  ...
  ru: {
    appTitle: "Громкость наушников",
    stepCounter: (n) => `Ситуация ${n} из ${STEPS}`,
    taskEyebrow: "Ситуация",
    questionEyebrow: "Какую громкость поставить",
    ...
    apply: "Поставить эту громкость",
    doneTitle: "Молодец! Громкость безопасна.",
    doneHint: "Безопасно — от 30 до 60. После 80 — опасно для ушей.",
    zoneLow: "Тихо",
    zoneSafe: "Безопасно",
    zoneLoud: "Громко",
    zoneDanger: "Опасно",
    cases: {
      music: {
        context: "Едешь в автобусе. Слушаешь музыку в наушниках.",
        task: "Выстави громкость так, чтобы слышать музыку, но не оглохнуть.",
        question: "Какая громкость безопасна?",
        hint: "Безопасная зелёная зона: 30–60. Это слышно, но не громко.",
        feedbackGood: "Верно. В зелёной зоне — уши не пострадают.",
        feedbackSoft: "Слишком громко. Если так час — будет звон в ушах.",
      },
      podcast: {
        context: "Делаешь домашку, слушаешь подкаст про природу.",
        task: "Поставь громкость, чтобы понимать речь, но не на полную.",
        question: "Какая громкость подходит?",
        hint: "Для речи 40–50 хватает. Громче — устают уши.",
        feedbackGood: "Правильно. Речь хорошо слышно на 40–50.",
        feedbackSoft: "Очень громко для речи. Слушаешь часами — заболят уши.",
      },
      video: {
        context: "Дома смотришь видео в наушниках вечером.",
        task: "Поставь спокойную громкость — дома не нужно громко.",
        question: "Какая громкость подходит для вечера?",
        hint: "Вечером дома достаточно 30–50.",
        feedbackGood: "Верно. Вечером дома 30–50 — то что надо.",
        feedbackSoft: "Дома вечером так громко не нужно. Сделай тише.",
      },
    },
  },
  uz: {
          ...
          {sit && !feedback ? (
            <div className="mq-panel-question">
              ...
              <p className="outfit-pick-summary">
                Сейчас: <strong>{volume}</strong> — {zoneLabel}
              </p>
            </div>
          ) : null}
