...
const dict: Locales<{
  ...
  ru: {
    appTitle: "Определитель кожи",
    stepCounter: (n) => `Лицо ${n} из ${STEPS}`,
    taskEyebrow: "Посмотри",
    questionEyebrow: "Тип кожи",
    hintEyebrow: "На что смотреть",
    feedbackEyebrow: "Проверка",
    skip: "Не знаю",
    next: "Следующее лицо",
    finish: "Закончить",
    retry: "Попробовать снова",
    doneTitle: "Молодец! Все типы кожи распознаны.",
    doneHint: "Ты узнал, как отличать жирную, сухую и нормальную кожу.",
    mirrorLabel: "Зеркало",
    options: {
      oily: "Жирная кожа",
      dry: "Сухая кожа",
    ...
    cases: {
      oily: {
        person: "Лицо 1",
        signals: ["лоб блестит", "поры расширены", "к вечеру жирный нос"],
        description: "На лице блестящие лоб и нос. Кожа выглядит блестящей и жирной.",
        question: "Какой это тип кожи?",
        hint: "Если кожа блестит и поры заметны — это жирная кожа.",
        feedbackGood: "Верно. Жирная кожа — блеск и расширенные поры.",
        feedbackSoft: "Посмотри: лицо блестит. Это не сухая и не нормальная кожа.",
      },
      dry: {
        person: "Лицо 2",
        signals: ["шелушение на щеках", "стянутая кожа", "матовая, без блеска"],
        description: "На щеках видно шелушение. Кожа стянутая, без блеска, матовая.",
        question: "Какой это тип кожи?",
        hint: "Если кожа шелушится и стягивается — это сухая кожа.",
        feedbackGood: "Верно. Сухая кожа — шелушение и стянутость.",
        feedbackSoft: "Посмотри на щёки — шелушение. Это не жирная и не нормальная.",
      },
      normal: {
        person: "Лицо 3",
        signals: ["ровный тон", "нет блеска", "нет шелушения"],
        description: "Кожа ровная, без блеска и без шелушения — выглядит спокойно.",
        question: "Какой это тип кожи?",
        hint: "Если нет ни блеска, ни шелушения — это нормальная кожа.",
        feedbackGood: "Верно. Нормальная кожа — без проблем.",
        feedbackSoft: "Посмотри: лицо ровное, нет блеска и шелушения. Это нормальная.",
      },
    },
  },
  uz: {
