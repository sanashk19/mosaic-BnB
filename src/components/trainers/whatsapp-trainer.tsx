...
const defaultOtherChatsByLocale: Record<Locale, OtherChat[]> = {
  ru: [
    { name: "Семейный чат", avatar: "С", lastMessage: "Тётя Дилбар: купите хлеб", time: "13:48", unread: 4 },
    { name: "Школа уведомления", avatar: "Ш", lastMessage: "Завтра холодно, тёплая одежда", time: "12:21" },
    { name: "Соседка Мария", avatar: "М", lastMessage: "Спасибо за помощь!", time: "вчера" },
    { name: "WhatsApp", avatar: "W", lastMessage: "Новые функции этой осенью", time: "пн" },
  ],
  uz: [
...
const dict = {
  ru: {
    ...
    instruction: "Открой чат с непрочитанным сообщением и выбери один спокойный ответ.",
    question: "Что лучше написать?",
    statusList: "Найди чат с непрочитанным сообщением.",
    statusNotChosen: "Ответ еще не выбран.",
    statusSent: "Ответ отправлен в чат.",
    hint: "Выбирай ответ без грубости, без лишних личных данных и без спешки.",
