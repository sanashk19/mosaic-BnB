...
const defaultContactsByLocale: Record<Locale, ContactItem[]> = {
  ru: [
    { name: "Mother", number: "998901234567", group: "Family" },
    { name: "Dad", number: "998937776655", group: "Family" },
    { name: "Grandma", number: "998712345678", group: "Family" },
    { name: "Teacher Olga Sergeevna", number: "998901112233", group: "School" },
    { name: "Ambulance", number: "103", group: "Emergency" },
    { name: "The police", number: "102", group: "Emergency" },
    { name: "Fire department", number: "101", group: "Emergency" },
    { name: "Gas service", number: "104", group: "Emergency" },
  ],
  uz: [
...
const defaultRecentsByLocale: Record<Locale, RecentItem[]> = {
  ru: [
    { name: "Mother", number: "998901234567", when: "today · 14:02" },
    { name: "Unknown number", number: "+1 415 555 0123", when: "today · 11:45", missed: true },
    { name: "Teacher Olga Sergeevna", number: "998901112233", when: "yesterday · 15:30" },
    { name: "Dad", number: "998937776655", when: "yesterday · 09:10" },
  ],
  uz: [
...
const dict = {
  ru: {
    ...
    appTitle: "Phone",
    taskLabel: "Exercise:",
    dialPlaceholder: "Dial the number",
    ...
    tabKeypad: "Keys",
    deleteAria: "Delete",
    callingStatus: "there is a call",
    callerEmergency: {
      "103": "Ambulance",
      "102": "The police",
      "101": "Fire department",
    } as Record<string, string>,
    doneTitle: "Connection established",
    doneHint: "Speak calmly: what happened and where you are.",
    panelTitle: "Dial the number",
    panelQuestion: "What should you do on your phone?",
    callingStatusPanel: "There is a call.",
    doneStatusPanel: "The connection has been established.",
    dialedStatus: (n: string) => `Typed:${n}`,
    notDialedStatus: "The number has not yet been dialed.",
    hint: (n: string) => `Required number:${n}. Open Contacts or type on the keys.`,
    feedbackCorrect: "Right",
    feedbackSoft: "Let's try again",
    next: "Next",
    retry: "Try again",
    note1: "Find it in Contacts or type on the keys.",
    note2: "Press the green call button.",
    overlayGood: "Well done!",
    overlaySoft: "Wrong number",
    continue: "Continue",
    retryOverlay: "Try again",
