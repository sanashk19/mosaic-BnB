...
const dict: Locales<{
  ...
  ru: {
    appTitle: "Digital cabinet",
    stepCounter: (n) => `Image${n}from${SITUATION_COUNT}`,
    ...
    ready: "Done",
    retry: "Try again",
    doneTitle: "Well done! Three images are collected.",
    doneHint: "You have learned to choose clothes for the situation.",
    silhouettePrompt: "Click on the top and bottom - they will appear on the silhouette.",
    pickTop: "Top",
    pickBottom: "Through",
    tops: {
      "school-shirt": "School shirt",
      "sport-tee": "Sports T-shirt",
      "party-shirt": "Dressy shirt",
    },
    bottoms: {
      "school-pants": "School trousers",
      "sport-shorts": "Sports shorts",
      "party-pants": "Dressy trousers",
    },
    situations: {
      school: {
        label: "To school",
        task: "Monday morning. You go to school for lessons.",
        question: "Choose clothes for school.",
        hint: "To school - school uniform: shirt and trousers. Not shorts.",
        correctTop: "school-shirt",
        correctBottom: "school-pants",
        feedbackGood: "Right. To school - school uniform.",
        feedbackSoft: "This is not for school. They wear uniforms at school.",
      },
      sports: {
        label: "For physical education",
        task: "The third lesson is physical education. We run and jump.",
        question: "Choose clothes for physical education.",
        hint: "For physical education - sportswear: T-shirt and shorts.",
        correctTop: "sport-tee",
        correctBottom: "sport-shorts",
        feedbackGood: "Right. For sports - light sportswear.",
        feedbackSoft: "This is uncomfortable to run in. Take sportswear.",
      },
      party: {
        label: "For a friend's birthday",
        task: "In the evening it’s a friend’s birthday. There will be cake and guests.",
        question: "Choose smart clothes.",
        hint: "For a holiday - smart: shirt and trousers. Not sporty.",
        correctTop: "party-shirt",
        correctBottom: "party-pants",
        feedbackGood: "Great. For a holiday - an elegant look.",
        feedbackSoft: "That's not how you go to a birthday party. Take something fancy.",
      },
    },
  },
  uz: {
