...
const dict = {
  ru: {
    ...
    task: "Задание:",
    filterAll: "Все",
    filterDelivery: "С доставкой завтра",
    filterDiscount: "Скидки",
    filterTopRated: "Высокий рейтинг",
    foundProducts: (n: number) => `Найдено ${n} товаров`,
    reviews: (n: number) => `${n} отзывов`,
    deliveryDefault: (i: number) => i === 0 ? "Доставка завтра, бесплатно" : "Доставка через 2 дня",
    addToCart: "В корзину",
    backToResults: "К результатам",
    reviewsDetail: (n: number) => `${n} отзывов`,
    sellerLabel: "Продавец:",
    sellerDefault: "Uzum Market",
    descriptionDefault: "Качественный товар от проверенного продавца. Возврат в течение 14 дней. Гарантия производителя.",
    deliveryDefaultProduct: "Доставка завтра, бесплатно",
    pickupOrCourier: "До пункта выдачи или курьером до двери",
    buyNow: "Купить сейчас",
    backToProduct: "Назад к товару",
    cartOneItem: "Корзина · 1 товар",
    sellerShort: (s: string) => `Продавец: ${s}`,
    rowProducts: (n: number) => `Товары (${n})`,
    ...
    pickupAddr: "ул. Амира Темура, 16",
    paymentSection: "Способ оплаты",
    payCard: "Картой онлайн",
    payCardSub: "UzCard · Humo",
    payCash: "Наличными при получении",
    payCashSub: "В пункте выдачи",
    toPay: "К оплате",
    confirmOrder: "Подтвердить заказ",
    orderDone: "Заказ оформлен",
    orderNumber: (n: number) => `Номер заказа: UZ-${n}`,
    cartHint: "Доставим завтра в пункт выдачи. Придёт SMS, когда можно забрать.",
    panelTitle: "Выбери товар",
    question: "Какой товар подходит?",
    statusNotChosen: "Товар еще не выбран.",
    statusDone: "Заказ оформлен.",
    statusInCart: "Товар в корзине. Оформи заказ.",
    hint: "Смотри на название, цену и описание. Открой карточку нужного товара.",
    ...
    continue: "Продолжить",
    starsAria: (rating: number) => `Рейтинг ${rating} из 5`,
  },
  uz: {
    cartAria: "Savatcha",
    crumbSearch: "Qidiruv",
