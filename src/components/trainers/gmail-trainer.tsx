...
const defaultInboxByLocale: Record<Locale, InboxItem[]> = {
  ru: [
    { from: "Google Command", subject: "Tip of the day", preview: "Use a strong password and do not open links from strangers.", time: "12:14", unread: true },
    { from: "School №12", subject: "Schedule for tomorrow", preview: "Dear parents, tomorrow is a physical education lesson...", time: "yesterday" },
    { from: "uzcard@notice.uz", subject: "Check: payment 25,000 soum", preview: "Thank you for shopping in the store...", time: "Tue" },
    { from: "Subscribe to Stories", subject: "5 ideas for the weekend", preview: "A selection of interesting places...", time: "01.05" },
  ],
  uz: [
...
const dict = {
  ru: {
    ...
    question: {
      inbox: "Click \"Write\".",
      recipient: "Who should I send the letter to?",
      body: "Which letter text should I choose?",
    },
