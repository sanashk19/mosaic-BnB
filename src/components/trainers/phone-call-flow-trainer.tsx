...
const dict: Locales<{
  ...
  ru: {
    ...
    doneTitle: "Молодец! Ты знаешь, как вести себя с телефоном.",
    doneHint: "Маме — отвечать; в экстренном случае — 103; незнакомому — отклонять.",
    actions: {
      answer: { name: "Ответить", sub: "взять трубку" },
      decline: { name: "Отклонить", sub: "не разговаривать" },
      "dial-103": { name: "Набрать 103", sub: "вызвать скорую" },
      "dial-mom": { name: "Позвонить маме", sub: "сначала маме" },
      block: { name: "Заблокировать", sub: "добавить в блок" },
    },
    cases: {
      "incoming-mom": {
        context: "Мама звонит. Она хочет узнать, как у тебя дела.",
        question: "Что сделать?",
        hint: "Маме всегда отвечай — она волнуется.",
        feedbackGood: "Верно. Маме отвечать обязательно.",
        feedbackSoft: "Маму отклонять нельзя. Она волнуется.",
        caller: "Мама",
        phone: "+998 90 123 45 67",
        mode: "incoming",
      },
      "outgoing-emergency": {
        context: "Человеку на улице плохо, нужна срочная помощь.",
        question: "Кому звонить?",
        hint: "Скорая — 103. Это бесплатный номер.",
        feedbackGood: "Верно. 103 — скорая, помогут.",
        feedbackSoft: "Это не поможет. Нужна скорая — 103.",
        caller: "Срочно нужна помощь",
        phone: "103",
        mode: "outgoing",
      },
      "unknown-caller": {
        context: "Звонят с незнакомого номера. Голос просит код из SMS.",
        question: "Что сделать?",
        hint: "Незнакомому никогда не говори код. Отклонить.",
        feedbackGood: "Верно. Незнакомому код не давать — отклонить.",
        feedbackSoft: "Незнакомому отвечать опасно. Отклонить — самый правильный выбор.",
  ...
  const scene: ReactNode = isDone ? (
    ...
    <div className={`callflow-app callflow-app--${c.mode}`}>
      <div className="callflow-status">
        {c.mode === "incoming" ? "Входящий звонок" : c.mode === "unknown" ? "Звонок · Неизвестный" : "Срочный вызов"}
      </div>
